  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "glass border-b border-border py-3 shadow-[0_8px_40px_rgba(0,0,0,0.35)]"
          : "bg-transparent py-5"
      )}
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav
          className="hidden items-center gap-1 rounded-full border border-transparent p-1 lg:flex"
